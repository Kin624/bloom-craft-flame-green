...
--[[CURRENT SCRIPT NAME]] 
local CURRENT_SCRIPT_NAME = "CPM1_IDNAME_MENU_v" .. CURRENT_VERSION .. ".lua"
...
--[[
  ============================================================
  CPM1 ID / NAME MENU v4.9.10  — SCRIPT_ID = IDNAMEMENU
  ============================================================
]]
...
local title =
"╔═══════════⊱✫⊰═══════════╗\n" ..
" CPM1 ID / NAME MENU 4.9.10\n" ..
" SCRIPT_ID: IDNAMEMENU\n" ..
"╚═══════════⊱✫⊰═══════════╝"
...
function Home()
    ...
    if m == 1 then pcall(changeID) end
    if m == 2 then pcall(longname) end
    if m == 3 then pcall(bypasslongname) end
