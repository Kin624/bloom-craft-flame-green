...
--[[CURRENT SCRIPT NAME]] 
local CURRENT_SCRIPT_NAME = "CPM1_UNLOCKCAR_MENU_v" .. CURRENT_VERSION .. ".lua"
...
--[[
  ============================================================
  CPM1 UNLOCK CAR MENU v4.9.10  — SCRIPT_ID = UNLOCKCARMENU
  ============================================================
]]
...
local title =
"╔═══════════⊱✫⊰═══════════╗\n" ..
" CPM1 UNLOCK CAR MENU 4.9.10\n" ..
" SCRIPT_ID: UNLOCKCARMENU\n" ..
"╚═══════════⊱✫⊰═══════════╝"


-- ============================================================
-- UNLOCK CAR FUNCTIONS
-- ============================================================
function carunlock()
...
function Home()
    local m = gg.choice({
        ...
        "『 UNLOCK CAR SEARCH v3 ༒』",
        "『 UNLOCK CAR SEARCH v4 ༒』",
        "『༒ EXIT ⌦ ༒』",
    }, nil, title)

    if m == nil then return end
    if m == 1 then pcall(carunlock) end
    if m == 2 then pcall(unlockcar2) end
    if m == 3 then pcall(unlockCarSearchV3) end
    if m == 4 then pcall(unlockCarSearchV4) end
