...
--[[CURRENT SCRIPT NAME]] 
local CURRENT_SCRIPT_NAME = "CPM1_KINGRANK_MENU_v" .. CURRENT_VERSION .. ".lua"
...
--[[
  ============================================================
  CPM1 KING RANK MENU v4.9.10  — SCRIPT_ID = KINGRANKMENU
  ============================================================
]]
...
local title =
"╔═══════════⊱✫⊰═══════════╗\n" ..
" CPM1 KING RANK MENU 4.9.10\n" ..
" SCRIPT_ID: KINGRANKMENU\n" ..
"╚═══════════⊱✫⊰═══════════╝"
...
function Home()
    ...
    if m == 1 then pcall(Menu_KINGRANK) end
