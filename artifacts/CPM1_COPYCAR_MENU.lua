...
--[[CURRENT SCRIPT NAME]] 
local CURRENT_SCRIPT_NAME = "CPM1_COPYCAR_MENU_v" .. CURRENT_VERSION .. ".lua"
...
--[[
  ============================================================
  CPM1 COPY CAR MENU v4.9.10  — SCRIPT_ID = COPYCARMENU
  ============================================================
]]
...
local title =
"╔═══════════⊱✫⊰═══════════╗\n" ..
" CPM1 COPY CAR MENU 4.9.10\n" ..
" SCRIPT_ID: COPYCARMENU\n" ..
"╚═══════════⊱✫⊰═══════════╝"
...
function Home()
    ...
    if m == 1 then pcall(smjCopycar) end
